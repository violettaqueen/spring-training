...
@JsonInclude(JsonInclude.Include.NON_NULL)  //only add fields that are not null, current temperature will be null
public class AddressDTO {
    ...
    private Integer currentTemperature;  //weather info from third party Api (consume)
